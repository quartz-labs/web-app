    ...
    <main className={"two-col-grid"}>
      ...
      <div>
        ...
        <p className={styles.subheading}>
          Creating an account requires 0.053 SOL for rent which can be reclaimed if you ever decide to close your
          account.
        </p>
        ...
        <ul className={styles.checkboxes}>
          <li>
            <label className={missingCheckboxes[0] ? styles.missingLabel : ""}>
              ...
              <span className={styles.checkboxText}>
                I accept the{" "}
                <a href="https://docs.quartzpay.io/terms-and-conditions" target="_blank">
          ...
          <li>
            <label className={missingCheckboxes[1] ? styles.missingLabel : ""}>
              ...
              <span className={styles.checkboxText}>
                I accept the{" "}
                <a href="https://docs.quartzpay.io/privacy-policy" target="_blank">
                  privacy policy
                </a>
                .
              </span>
          ...
          <li>
            <label className={missingCheckboxes[2] ? styles.missingLabel : ""}>
              ...
              <span className={styles.checkboxText}>
                ...
                <a href="https://docs.quartzpay.io/risks" target="_blank">
                  protocol disclaimer
                </a>
              </span>
            </label>
        ...
        <button onClick={handleCreateAccount} className={`glass-button ${styles.mainButton}`}>
          ...
          {!awaitingSign && <p>Create Account</p>}
        </button>

        {attemptFailed && <p className={styles.failMessage}>You must agree to all terms</p>}
      </div>
    </main>
  );
}
