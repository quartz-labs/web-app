...
export default function Modal({ variation, accountData, solPriceUSD, onClose }: ModalProps) {
        ...
        {(() => {
          switch (variation) {
            ...
            case ModalVariation.WithdrawUSDC:
              return <WithdrawUSDCModal accountData={accountData} isValid={isValid} closeModal={onClose} />;

            case ModalVariation.OfframpUSD:
              return <OfframpUSDModal accountData={accountData} isValid={isValid} closeModal={onClose} />;

            case ModalVariation.OfframpComplete:
              return <OfframpCompleteModal closeModal={onClose} url={""} />;

            case ModalVariation.RepayUSDC:
              return <RepayUSDCModal accountData={accountData} isValid={isValid} closeModal={onClose} />;

            case ModalVariation.RepayUSDCWithCollateral:
              return <RepayUSDCWithCollateralModal accountData={accountData} isValid={isValid} closeModal={onClose} />;

            case ModalVariation.Telegram:
              return <TelegramModal closeModal={onClose} />;

            case ModalVariation.CloseAccount:
              return <CloseAccountModal closeModal={onClose} />;
