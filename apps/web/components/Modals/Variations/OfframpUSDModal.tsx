...
export default function OfframpUSDModal({ accountData, isValid, closeModal }: OfframpUSDModalProps) {
  ...
  return (
    <>
      ...
      <ModalInfoSection
        ...
        errorText={errorText}
      >
        {accountData && <p>({(accountData.usdcRate * 100).toFixed(4)}% APR)</p>}
      </ModalInfoSection>

      <ModalButtons label="Off-ramp" awaitingSign={awaitingSign} onConfirm={handleConfirm} onCancel={closeModal} />
    </>
  );
}
