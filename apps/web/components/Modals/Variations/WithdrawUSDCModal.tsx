...
export default function WithdrawUSDCModal({ accountData, isValid, closeModal }: WithdrawUSDCModalProps) {
    ...
    <>
      ...
      >
        <p>
          ...
          {accountData && <span className="tiny-text">({(accountData.usdcRate * 100).toFixed(4)}% APR)</span>}
        </p>
      </ModalInfoSection>
