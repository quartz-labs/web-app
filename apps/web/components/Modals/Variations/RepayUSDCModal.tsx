...
export default function RepayUSDCModal({ accountData, isValid, closeModal }: RepayUSDCModalProps) {
  ...
  return (
    <>
      ...
      <ModalInfoSection
        ...
        errorText={errorText}
      >
        {accountData && <p>Loan remaining: {baseUnitToUi(accountData.usdcBalanceBaseUnits, DECIMALS_USDC)}</p>}
      </ModalInfoSection>

      <ModalButtons label="Repay" awaitingSign={awaitingSign} onConfirm={handleConfirm} onCancel={closeModal} />
    </>
  );
}
