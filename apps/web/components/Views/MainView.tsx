  ...
  return (
    <div className="dashboard-wrapper">
      {loading && (
        <div className={styles.balanceWrapper}>
          <div className={styles.loadingBalance}>
            ...
            <PuffLoader color={"#ffffff"} size={50} aria-label="Loading" data-testid="loader" />
          </div>
        </div>
      )}
      ...
      {!loading && (
        <div className={styles.balanceWrapper}>
          <div>
            <p className={styles.title}>{truncateToDecimalPlaces(netSolBalance, 5)} SOL</p>
      ...
      <div className={styles.buttons}>
        <div className={styles.buttonsRow}>
          <button onClick={handleDepositSol} className={"glass-button"}>
            Deposit SOL
          </button>
          <button onClick={handleWithdrawSol} className={"glass-button"}>
            Withdraw SOL
          </button>
        </div>
