...
function BaseWalletMultiButton(_a) {
  var { children, labels, onCloseAccount, disableCloseAccount } = _a,
    props = __rest(_a, ["children", "labels", "onCloseAccount", "disableCloseAccount"]);
  const { setVisible: setModalVisible } = (0, useWalletModal_js_1.useWalletModal)();
  const { buttonState, onConnect, onDisconnect, publicKey, walletIcon, walletName } = (0,
  wallet_adapter_base_ui_1.useWalletMultiButton)({
    onSelectWallet() {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      BaseWalletConnectionButton_js_1.BaseWalletConnectionButton,
      Object.assign({}, props, {
        "aria-expanded": menuOpen,
        style: Object.assign({ pointerEvents: menuOpen ? "none" : "auto" }, props.style),
        onClick: () => {
          switch (buttonState) {
            case "no-wallet":
              setModalVisible(true);
