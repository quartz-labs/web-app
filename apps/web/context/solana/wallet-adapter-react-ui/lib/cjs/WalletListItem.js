...
const WalletListItem = ({ handleClick, tabIndex, wallet }) => {
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      {
        onClick: handleClick,
        startIcon: react_1.default.createElement(WalletIcon_js_1.WalletIcon, { wallet: wallet }),
        tabIndex: tabIndex,
      },
      wallet.adapter.name,
      wallet.readyState === wallet_adapter_base_1.WalletReadyState.Installed &&
        react_1.default.createElement("span", null, "Detected"),
    ),
  );
};
