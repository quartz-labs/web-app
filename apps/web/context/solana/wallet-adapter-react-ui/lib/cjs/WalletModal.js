...
const WalletModal = ({ className = "", container = "body" }) => {
  ...
  const handleWalletClick = (0, react_1.useCallback)(
    (event, walletName) => {
      select(walletName);
      handleClose(event);
    },
  ...
  const handleTabKey = (0, react_1.useCallback)(
    (event) => {
  ...
  return (
    ...
    (0, react_dom_1.createPortal)(
      react_1.default.createElement(
              ...
              ? react_1.default.createElement(
                  ...
                  react_1.default.createElement(
                    ...
                    listedWallets.map((wallet) =>
                      react_1.default.createElement(WalletListItem_js_1.WalletListItem, {
                    ...
                    collapsedWallets.length
                      ? react_1.default.createElement(
                          Collapse_js_1.Collapse,
                          { expanded: expanded, id: "wallet-adapter-modal-collapse" },
        ...
        react_1.default.createElement("div", { className: "wallet-adapter-modal-overlay", onMouseDown: handleClose }),
      ),
      portal,
    )
  );
