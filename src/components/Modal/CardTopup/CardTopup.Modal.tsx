import { validateAmount, fetchAndParse, deserializeTransaction, buildEndpointURL, formatPreciseDecimal, signAndSendTransaction } from "@/src/utils/helpers";
...
export default function CardTopupModal() {
    ...
    return (
        <div className={styles.contentWrapper}>
            <h2 className={styles.heading}>Add funds to your card</h2>
