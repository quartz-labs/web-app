...
describe("transfer_lamports tests", () => {
  ...
  it("transfer_lamports insufficient funds", async () => {
    const { program, vaultPda, backupKeypair, userKeypair } = testSetup;
    ...
    try {
      ...
      assert.fail(0, 1, "transfer_lamports instruction call should have failed")
    } catch(err) {
  ...
  it("transfer_lamports incorrect signature", async () => {
    const { provider, program, vaultPda, backupKeypair, userKeypair, quartzManagerKeypair } = testSetup;
  ...
  it("transfer_lamports incorrect user", async () => {
    const { provider, program, vaultPda, backupKeypair, userKeypair } = testSetup;
  ...
  it("transfer_lamports incorrect backup", async () => {
  ...
  it("transfer_lamports incorrect vaultPda", async () => {
    const { provider, program, vaultPda, userKeypair, otherKeypairVaultPda, backupKeypair } = testSetup;
