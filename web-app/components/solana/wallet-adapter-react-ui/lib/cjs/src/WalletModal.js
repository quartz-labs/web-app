                ...
                react_1.default.createElement("div", { className: "wallet-adapter-modal-wrapper" },
                    ...
                    listedWallets.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                        ...
                        react_1.default.createElement("ul", { className: "wallet-adapter-modal-list" },
                            listedWallets.map((wallet) => (react_1.default.createElement(WalletListItem_1.WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet: wallet }))),
                            collapsedWallets.length ? (react_1.default.createElement(Collapse_1.Collapse, { expanded: expanded, id: "wallet-adapter-modal-collapse" }, collapsedWallets.map((wallet) => (react_1.default.createElement(WalletListItem_1.WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet: wallet }))))) : null),
                        ...
                        collapsedWallets.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                            ...
                            react_1.default.createElement(Collapse_1.Collapse, { expanded: expanded, id: "wallet-adapter-modal-collapse" },
                                react_1.default.createElement("ul", { className: "wallet-adapter-modal-list" }, collapsedWallets.map((wallet) => (react_1.default.createElement(WalletListItem_1.WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet: wallet }))))))) : null)))),
