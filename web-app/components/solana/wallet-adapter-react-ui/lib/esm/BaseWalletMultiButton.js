...
export function BaseWalletMultiButton({ children, labels, onCloseAccount, disableCloseAccount, ...props }) {
    ...
    return (React.createElement("div", { className: "wallet-adapter-dropdown" },
        ...
        React.createElement("ul", { "aria-label": "dropdown-list", className: `wallet-adapter-dropdown-list ${menuOpen && 'wallet-adapter-dropdown-list-active'}`, ref: ref, role: "menu" },
            ...
            !disableCloseAccount ? (React.createElement("li", { className: "wallet-adapter-dropdown-list-item", onClick: () => {
                    setMenuOpen(false);
                    onCloseAccount();
