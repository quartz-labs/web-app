...
export const DRIFT_ADDITIONAL_ACCOUNT_1 = new PublicKey("BAtFj4kQttZRVep3UZS2aZRDixkGYgWsbqTBVDbnSsPF");
export const DRIFT_ADDITIONAL_ACCOUNT_2 = new PublicKey("En8hkHLkRe9d9DraYmBTrus518BvmVH448YcvmrFM6Ce");
